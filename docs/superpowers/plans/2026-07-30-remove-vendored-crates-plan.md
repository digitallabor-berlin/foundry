...
> Migrated from `docs/superpowers/plans/2026-07-30-remove-vendored-crates-plan.md` — produced by the retired
> `superlight` workflow (see `docs/superpowers/changes/2026-08-03-retire-superlight-workflow.md`).

**Spec:** docs/superpowers/specs/2026-07-30-remove-vendored-crates-spec.md
...
- `grep -rn 'oid4vci\|openid4vp' --include='*.md' .` returns hits only in
  ...
  `docs/superpowers/**` (this spec/plan/changelog, which discuss them by
