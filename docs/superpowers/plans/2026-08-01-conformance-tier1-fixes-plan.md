...
> Migrated from `docs/superpowers/plans/2026-08-01-conformance-tier1-fixes-plan.md` — produced by the retired
> `superlight` workflow (see `docs/superpowers/changes/2026-08-03-retire-superlight-workflow.md`).

**Spec:** [`docs/superpowers/specs/2026-08-01-conformance-tier1-fixes-spec.md`](../specs/2026-08-01-conformance-tier1-fixes-spec.md)
