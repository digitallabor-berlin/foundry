...
> Migrated from `docs/superpowers/changes/2026-07-28-authz-code-flow.md` — produced by the retired
...
**Spec:** `docs/superpowers/specs/2026-07-28-authz-code-flow-spec.md`
**Plan:** `docs/superpowers/plans/2026-07-28-authz-code-flow-plan.md`
